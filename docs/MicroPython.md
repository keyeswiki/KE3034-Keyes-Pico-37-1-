...
![](media/bb9c2df6be74f4abdcc00ad4eafdd2a9.jpeg)测试代码
...
nums = keys % 7 \#按键次数对7取余,得到0 1 2 3 4 5 6
...
1.  设置时，我们参考本章节实验四十四方法。利用按键中断计算出按下按键的次数，除以7，得到余数，为0     1 2 3 4 5     6，根据不同的余数，构造7个独一的函数来控制实验实现不同功能。
